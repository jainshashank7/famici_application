...
import 'package:famici/shared/call_card.dart';
...
import 'fc_home_screen.dart';

class CustomerSupportHomeScreen extends StatefulWidget {
  const CustomerSupportHomeScreen({super.key});

  @override
  State<CustomerSupportHomeScreen> createState() =>
                                                            ...
                                                            if(stateM
                                                              ...
                                                              CallingCard(
                                                                ...
                                                                dtmsSettings: stateM
                                                                    ...
                                                                    ?.dtmsSettings ??
                                                                    "",
                                                                isAudioEnabled: stateM.dashboardBuilder.li.items["LI 3"]?.isAudioEnabled ?? false,
                                                                audioFileId: stateM.dashboardBuilder.li.items["LI 3"]?.documentId ?? "",
                                                            ...
                                                            if(stateM
                                                              ...
                                                              CallingCard(
                                                                  ...
                                                                  dtmsSettings: stateM
                                                                      ...
                                                                      ?.dtmsSettings ??
                                                                      "",
                                                                  isAudioEnabled: stateM.dashboardBuilder.li.items["LI 6"]?.isAudioEnabled ?? false,
                                                                  audioFileId: stateM.dashboardBuilder.li.items["LI 6"]?.documentId ?? "",
                                                              ),
                                                            if(stateM
                                                                .dashboardBuilder
                                                                .li
