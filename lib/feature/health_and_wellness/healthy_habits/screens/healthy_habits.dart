...
import 'package:famici/feature/health_and_wellness/healthy_habits/screens/story_details.dart';
import 'package:famici/feature/health_and_wellness/healthy_habits/screens/story_topics.dart';
...
class HealthyHabitsScreen extends StatefulWidget {
  ...
  @override
  _HealthyHabitsScreenState createState() => _HealthyHabitsScreenState();
}

class _HealthyHabitsScreenState extends State<HealthyHabitsScreen> {
  late HealthyHabitsBloc _healthyHabitsBloc;
  final FocusScopeNode _node = FocusScopeNode();
  @override
  void initState() {
    context.read<HealthyHabitsBloc>().add(FetchCategoriesEvent());
    _healthyHabitsBloc = context.read<HealthyHabitsBloc>();
    _healthyHabitsBloc.add(FetchStoriesEvent());
    super.initState();
  }

  @override
  void dispose() {
    _healthyHabitsBloc.add(ResetHealthyHabitsEvent());
    super.dispose();
  }
        ...
        if (connectivity.hasInternet) {
          return FocusScope(
            ...
            child: FamiciScaffold(
              ...
              child: BlocBuilder<HealthyHabitsBloc, HealthyHabitsState>(
                builder: (
                  context,
                  HealthyHabitsState state,
                ) {
                  return Container(
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // ),
                              Expanded(
                                child: BlocBuilder<HealthyHabitsBloc,
                                    HealthyHabitsState>(
                          ...
                          child: Container(
                            ...
                            child: Builder(builder: (context) {
                              if (state.isLoading) {
                                ...
                                return Center(
                                  child: Text(
                                    "${state.selectedCategory.id != topStories.id && state.selectedCategory.id != searchingForBlog.id ? state.selectedCategory.name + " stories" : state.selectedCategory.name} not found.",
