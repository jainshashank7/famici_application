...
class EditMedicationSuccessPopup extends StatelessWidget {
  const EditMedicationSuccessPopup({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                MedicationStrings.yourMedicationHasBeenEdited.tr(),
                style: TextStyle(
                  color: ColorPallet.kPrimaryTextColor,
                  fontSize: FCStyle.largeFontSize,
                  fontWeight: FontWeight.bold,
