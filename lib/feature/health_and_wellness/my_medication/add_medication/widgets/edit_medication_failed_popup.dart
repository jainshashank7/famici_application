...
class EditMedicationFailedPopup extends StatelessWidget {
  const EditMedicationFailedPopup({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                MedicationStrings.medicationEditFailed.tr(),
                style: TextStyle(
                  color: ColorPallet.kPrimaryTextColor,
                  fontSize: FCStyle.largeFontSize,
                  fontWeight: FontWeight.bold,
