...
class ViewVitalScreen extends StatelessWidget {
  const ViewVitalScreen({
    Key? key,
    required this.vital,
  }) : super(key: key);
                              ...
                              FCMaterialButton(
                                ...
                                onPressed: () {
                                  ...
                                  context.read<VitalHistoryBloc>().add(
                                      SyncSelectedVital(_vital.vitalType,
                                          isRefreshed: false));
                          ...
                          child: Column(
                            ...
                            children: [
                              BlocBuilder<VitalsAndWellnessBloc,
                                ...
                                builder: (context, vitalState) {
                                  Vital _vital =
                                      vitalState.vitalList.firstWhere(
                                    (el) => el.vitalType == vital.vitalType,
                                  );
...
class ViewVitalSubtitle extends StatelessWidget {
  const ViewVitalSubtitle({
    Key? key,
    required this.vital,
  }) : super(key: key);
