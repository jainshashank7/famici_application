...
//   //   );
//   var sideEvent = SideEventArranger<T>();
//   List<Widget> _generateEvents() {
//     final events = sideEvent.arrange(
//       events: this.events,
//       height: height,
//       width: width,
//       heightPerMinute: heightPerMinute,
...
//           index.toString() +
//           ' eve top' +
//           events[index].top.toString() +
//           ' eve left' +
//           events[index].left.toString() +
//           ' eve right' +
//           events[index].right.toString());
//       return Positioned(
//         top: events[index].top - 60,
//         bottom: events[index].bottom + 60,
...
//               height - events[index].bottom + 60 - events[index].top - 60,
//             ),
