                ...
                child: Column(
                    ...
                    children: [
                      Column(
                        mainAxisSize: MainAxisSize.min,
                        children: List.generate(
                          events.length > 2 ? 1 : events.length,
                          (index) => GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    '${DateFormat('hh:mma').format(events[index].startTime!).replaceAll('am', 'AM').replaceAll('pm', 'PM')} - ${DateFormat('hh:mma').format(events[index].endTime!).replaceAll('am', 'AM').replaceAll('pm', 'PM')}',
                                    overflow: TextOverflow.clip,
                                    maxLines: 1,
                                    style: TextStyle(
