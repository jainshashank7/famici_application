...
class DayViewState<T extends Object?> extends State<DayView<T>> {
  ...
  Widget _defaultEventTileBuilder(
    ...
    if (events.isNotEmpty)
      return RoundedEventTile(
        ...
        // description: events[0].description,
        padding: EdgeInsets.all(10.0),
        backgroundColor: events[0].color ?? Colors.amber,
        margin: EdgeInsets.all(2.0),
  ...
  Widget _defaultDayBuilder(DateTime date) {
    return DayPageHeader(
      iconColor: widget.AppDynamicColor ?? Color.fromARGB(255, 89, 91, 196),
      date: _currentDate,
      backgroundColor:
          widget.AppDynamicColor ?? Color.fromARGB(255, 89, 91, 196),
