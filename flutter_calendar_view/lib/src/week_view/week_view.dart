...
//         initialScrollOffset: widget.scrollOffset, keepScrollOffset: false);
//     _pageController = PageController(initialPage: _currentIndex);
//     _eventArranger = SideEventArranger<T>();
...
//                   onTap: () {
//                     _scrollController.animateTo(
//                       _scrollController.position.pixels + 105,
//                       duration: Duration(milliseconds: 300),
//                       curve: Curves.easeIn,
//                     );
//                   },
...
class WeekViewState<T extends Object?> extends State<WeekView<T>> {
  ...
  Widget _defaultWeekPageHeaderBuilder(DateTime startDate, DateTime endDate) {
    return WeekPageHeader(
      backgroundColor: widget.AppDynamicColor ?? Color(0xFF5155C3),
      startDate: _currentStartDate,
      endDate: _currentEndDate,
      onNextDay: nextPage,
      onPreviousDay: previousPage,
          ...
          builder: (BuildContext context, Widget? child) {
            return Theme(
                data: ThemeData.light().copyWith(
                  primaryColor: widget.AppDynamicColor ?? Color(0xFF5155C3),
                  accentColor: widget.AppDynamicColor ?? Color(0xFF5155C3),
                  colorScheme: ColorScheme.light(
                      primary: widget.AppDynamicColor ?? Color(0xFF5155C3)),
                  buttonTheme:
