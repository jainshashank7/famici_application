...
class _StackViewState extends _CustomLayoutStateBase<_StackSwiper> {
  ...
  void _updateValues() {
    if (widget.scrollDirection == Axis.horizontal) {
      ...
      offsets = widget.axisDirection == AxisDirection.left
          ...
          : [_swiperWidth * 1.4, 0.0, 0.0, 0.0, 0.0];
      offsetsY = [0.0, _swiperHeight * 0.02, -_swiperHeight * 0.05, -_swiperHeight * 0.12, 0.0];
      // offsetsY = [0, 0, -30, -60, 0];
    } else {
  ...
  void afterRender() {
    ...
    opacity =
        isRightSide ? [1.0, 1.0, 0.6, 0.4, 0.0] : [0.0, 0.5, 1.0, 1.0, 1.0];
